...
export default function Home() {
  ...
  const shopName = "smapi mobile.shop"; 
  // useEffect này sẽ tự động chạy 1 lần duy nhất khi web vừa load xong.
  // Nhiệm vụ: Đổi tiêu đề trên tab của trình duyệt
  useEffect(() => {
    document.title = `${shopName} - điện thoại Chính Hãng`;
  }, []); // Dấu [] rỗng nghĩa là chỉ chạy 1 lần lúc mới mở web
  // Danh sách các danh mục để tạo nút bấm (Tabs)
  const categories = ["Tất cả", "iphone", "samsung", "Games", "vivo", "oppo"];
  // Kho dữ liệu mô phỏng (Mock data) chứa danh sách sản phẩm
  const products = [
    { id: 1, name: "Điện thoại iPhone 17 Pro Max 256GB", price: "500.000đ", image: "/download (1).jpg", category: "iPhone",tap: "hot" },
    { id: 2, name: "Điện thoại iPhone Air 256GB", price: "300.000đ", image: "/download (4).jpg", category: "iPhone" },
    { id: 3, name: "Samsung Galaxy S26 Plus 5G (12GB+256GB)", price: "41.250.000đ", image: "/samsungs26.jpg", category: "samsung", tag: "Hot" },
    { id: 4, name: "iPhone 15 (Pro/Pro Max/Plus) ", price: "7.800.000đ", image: "/iphone-15-plus-128gb-den-thumb-600x600.jpg", category: "iPhone" },
    { id: 9, name: "oppo find x9s 12gb/256gb", price: "6.990.000đ", image: "/3Rh06H86VObbr1dR.jpg", category: "oppo" },
    { id: 10, name: "Điện thoại Xiaomi 17 Ultra 5G 16GB/512GB", price: "4.680.000đ", image: "/xiaomi-17-ultra-black-1-639088343322428022-750x500.jpg", category: "Console" },
    { id: 11, name: "RedMagic 11 Pro 5G 12GB 256GB", price: "19.990.000đ", image: "/download (5).jpg", category: "Games" },
    { id: 12, name: "Điện thoại Vivo iQOO Z10x 5G (Dimensity 7300)", price: "4.380.000đ", image: "/vivo-iqoo-z10x-xanh.jpg.webp", category: "vivo" }
  ];
